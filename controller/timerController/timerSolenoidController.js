...
exports.createTimerSolenoid = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsTimerSolenoid = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandTimerSolenoid = (req, res) => {
  ...
  //ลบคำสั่ง
exports.removeTimerSolenoid = (req, res) => {
    const { commandId } = req.params;
...
//แก้ไขคำสั่ง
exports.modifyTimerSolenoid = (req, res) => {
  const { commandId } = req.params;
