const commandData = require("../../../models/conditionData/irsensorDataModels/irsensorBuzzerData");

exports.createIrsensorBuzzer = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsIrsensorBuzzer = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandIrsensorBuzzer = (req, res) => {
  ...
  //ลบคำสั่ง
exports.removeIrsensorBuzzer = (req, res) => {
    const { commandId } = req.params;
  ...
  //แก้ไขคำสั่ง
exports.modifyIrsensorBuzzer = (req, res) => {
    const { commandId } = req.params;
