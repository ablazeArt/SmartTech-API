const commandData = require("../../../models/conditionData/irsensorDataModels/irsensorLedData");

exports.createIrsensorLed = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsIrsensorLed = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandIrsensorLed = (req, res) => {
  ...
  //ลบคำสั่ง
exports.removeIrsensorLed = (req, res) => {
    const { commandId } = req.params;
  ...
  //แก้ไขคำสั่ง
exports.modifyIrsensorLed = (req, res) => {
    const { commandId } = req.params;
