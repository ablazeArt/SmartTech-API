const commandData = require("../../../models/conditionData/levelDataModels/levelSolenoidData");

exports.createLevelSolenoid = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsLevelSolenoid = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandLevelSolenoid = (req, res) => {
  ...
  //ลบคำสั่ง
exports.removeLevelSolenoid = (req, res) => {
    const { commandId } = req.params;
  ...
  //แก้ไขคำสั่ง
exports.modifyLevelSolenoid = (req, res) => {
    const { commandId } = req.params;
