const commandData = require("../../../models/conditionData/levelDataModels/levelLedData");

exports.createLevelLed = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsLevelLed = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandLevelLed = (req, res) => {
  ...
  //ลบคำสั่ง
exports.removeLevelLed = (req, res) => {
    const { commandId } = req.params;
  ...
  //แก้ไขคำสั่ง
exports.modifyLevelLed = (req, res) => {
    const { commandId } = req.params;
