const commandData = require("../../../models/conditionData/tempDataModels/tempLedData");

exports.createTempLed = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsTempLed = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandTempLed = (req, res) => {
