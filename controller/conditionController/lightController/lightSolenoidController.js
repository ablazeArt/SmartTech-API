const commandData = require("../../../models/conditionData/lightDataModels/lightSolenoidData");

exports.createLightSolenoid = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsLightSolenoid = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandLightSolenoid = (req, res) => {
  ...
  //ลบคำสั่ง
exports.removeLightSolenoid = (req, res) => {
    const { commandId } = req.params;
  ...
  //แก้ไขคำสั่ง
exports.modifyLightSolenoid = (req, res) => {
    const { commandId } = req.params;
