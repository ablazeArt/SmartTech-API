const commandData = require("../../../models/conditionData/humidityDataModels/humiditySolenoidData");

exports.createHumiditySolenoid = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsHumiditySolenoid = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandHumiditySolenoid = (req, res) => {
  ...
  //ลบคำสั่ง
exports.removeHumiditySolenoid = (req, res) => {
    const { commandId } = req.params;
  ...
  //แก้ไขคำสั่ง
exports.modifyHumiditySolenoid = (req, res) => {
    const { commandId } = req.params;
