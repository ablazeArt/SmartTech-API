const commandData = require("../../../models/conditionData/humidityDataModels/humidityBuzzerData");

exports.createHumidityBuzzer = (req, res) => {
  ...
  // ดึงคำสั่งทั้งหมด
exports.getAllCommandsHumidityBuzzer = (req, res) => {
  ...
  //ดึงเพียงคำสั่งเดียว
exports.singleCommandHumidityBuzzer = (req, res) => {
  ...
  //ลบคำสั่ง
exports.removeHumidityBuzzer = (req, res) => {
    const { commandId } = req.params;
  ...
  //แก้ไขคำสั่ง
exports.modifyHumidityBuzzer = (req, res) => {
    const { commandId } = req.params;
